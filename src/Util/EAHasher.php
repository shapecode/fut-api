...
class EAHasher
{
    private static EAHasher $instance;

    /** @var int[] */
    public static array $r1Shifts = [7, 12, 17, 22, 7, 12, 17, 22, 7, 12, 17, 22, 7, 12, 17, 22];

    /** @var int[] */
    public static array $r2Shifts = [5, 9, 14, 20, 5, 9, 14, 20, 5, 9, 14, 20, 5, 9, 14, 20];

    /** @var int[] */
    public static array $r3Shifts = [4, 11, 16, 23, 4, 11, 16, 23, 4, 11, 16, 23, 4, 11, 16, 23];

    /** @var int[] */
    public static array $r4Shifts = [6, 10, 15, 21, 6, 10, 15, 21, 6, 10, 15, 21, 6, 10, 15, 21];

    public static string $hexCharacters = '0123456789abcdef';
